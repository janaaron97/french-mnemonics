...
test('a studying word, a known word and a note round-trip through rows',()=>{
 ...
 assert.deepEqual(reviewRow(s,'7'),{word_id:7,due:iso(5000),interval_days:3,reviews:2,last_reviewed:iso(4000)});
 ...
 assert.deepEqual(back.state.cards,{'7':{due:5000,interval:3,reviews:2,last:4000}});
